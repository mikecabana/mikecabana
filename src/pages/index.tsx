				...
				<>
					...
					<section className='py-32'>
						...
						<div className='grid grid-cols-1 md:grid-cols-2 gap-24'>
							<div>
								<p className='pb-8'>
									My name is Michael Cabana, a Montreal based software developer. I’ve been a developer
									professionaly for just over 4 years.
								</p>
								<p className='pb-8'>
									I first got into web dev while in college where I was actually pursuing a career path
									towards a Doctor of Optometry. I took an intro to web development class as an elective
									and right away I knew this was the place for me!
								</p>
							</div>
					...
					<section className='py-24'>
						...
						<p className='max-w-md mx-auto text-center mb-12'>
							If your interested in working together, have any questions or just want to say hi, my inbox is
							always open!
						</p>
