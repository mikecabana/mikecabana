                ...
                <>
                    ...
                    <section className="border-primary-500 grid gap-8 grid-cols-1 md:grid-cols-12 mb-14">
                        <Card className="col-span-12 md:col-span-7 p-8 bg-gradient-to-bl from-background-500 to-background-600 dark:from-primary-950 dark:to-primary-900">
                            ...
                            <button
                                ...
                                className="px-8 w-full py-4 font-semibold flex items-baseline border border-accent-500 text-accent-600 dark:text-accent-500 rounded-xl transition hover:bg-accent hover:bg-opacity-10 active:bg-opacity-20"
                            >
                    ...
                    <section className="my-16 py-16" id="services">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                            ...
                            <Card className="relative p-8 border-0">
                                ...
                                <h3 className="relative z-10 big-text font-black dark:font-normal mb-6">
                                    AI & Automation
                                </h3>
                        ...
                        <div className="flex items-center justify-center mt-16">
                            <button
                                onClick={() => handleGetInTouch()}
                                className="border-0 px-6 py-2 text-accent-600 dark:text-accent-500 hover:underline active:font-medium"
                            >
                                {"Let's get to work!"}
                            </button>
                        </div>
                    ...
                    <section className="py-12" id="get-in-touch">
                        ...
                        <div className="text-center">
                            <button className="px-8 py-4 font-semibold border border-accent-500 text-accent-600 dark:text-accent-500 rounded-xl transition hover:bg-accent hover:bg-opacity-10 active:bg-opacity-20">
                                Say hello!
                            </button>
                        </div>
                    </section>
